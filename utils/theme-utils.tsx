export type ThemeVariant = "lighter" | "light" | "dark";
...
export const themeBgColorClassNames: Record<
  ThemeComponentColor,
  Record<ThemeVariant, {
    base: string;
    hover: string;
...
export const themeTextColorClassNames: Record<
  ThemeComponentColor,
  Record<ThemeVariant, string>
> = {
  blue: {
    dark: "text-white",
